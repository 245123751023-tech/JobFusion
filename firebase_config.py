...
if firebase_cred_json:
    ...
    cred = credentials.Certificate("config/fir-chat-e3c87-firebase-adminsdk-fbsvc-0eba3f02b8.json")

firebase_admin.initialize_app(cred, {
    'databaseURL': os.environ.get(
        "FIREBASE_DATABASE_URL",
        "https://fir-chat-e3c87-default-rtdb.asia-southeast1.firebasedatabase.app"
    ),
})
